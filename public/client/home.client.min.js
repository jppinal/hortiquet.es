...
b.post("/paypal-create",shoppingData).then(function(a){console.log(a);d.location.href=a.data.href},function(a){console.log(a)})}}]).directive("confirmStep",function(){return{restrict:"E",transclude:!0,scope:{},templateUrl:"/client/shopping/confirm/template.confirm.step.html",controller:"ConfirmStepController"}});angular.module("home").controller("HomeController",["$scope","Authentication","ShoppingFactory",function(a,b,c){a.authentication=b;a.cart=c.cart;a.resizeHomeItems=function(){var a=$(window).height();$("#home-slider .item").css("height",a)}}]);angular.module("home").config(["$routeProvider",function(a){a.when("/",{templateUrl:"/client/home/view.home.client.html",controller:"HomeController"}).when("/legal-notice",{redirectTo:"/legal/notice"}).when("/privacy-policy",{redirectTo:"/legal/privacy"}).when("/privacy-cookies",{redirectTo:"/legal/cookies"})}]);
